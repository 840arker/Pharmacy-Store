...
<html lang="en">
  <head>
    ...
    <title>Request for Approve Users </title>
      ...
      <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
          <a href="#" class="navbar-brand d-flex align-items-center">
            <strong>USER REQUEST NOTIFICATION<?php echo $_SESSION['admin_id'] ?></strong>
          </a>
            ...
            <div class="pull-right">
                ...
                <form method="post">
                    ...
                    <a href="home.php" class="btn btn-light my-2">Back</a>
